...
class Draw:
    ...
    def point(self, *, size: int = DEFAULT_BRUSH_SIZE, color: str = DEFAULT_FIRST_COLOR) -> None: ...
...
class Events:
    ...
    def event_btnBrush(self, *, size: int = DEFAULT_BRUSH_SIZE, color: str = DEFAULT_FIRST_COLOR) -> None: ...
