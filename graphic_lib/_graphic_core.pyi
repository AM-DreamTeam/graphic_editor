...
class Draw:
    ...
    def point(self, *, size: int = DEFAULT_SIZE, color: str = DEFAULT_FIRST_COLOR) -> None: ...
    ...
    def move(self, *, mouse_speed: DEFAULT_MOUSE_SPEED) -> None: ...

# _events.py
class Events:
    def __init__(self, root: Tk, used_events: Tuple[str], canvas: CustomCanvas): ...
    def event_btnClear(self) -> None: ...
    def event_btnBrush(self, *, size: int = DEFAULT_SIZE, color: str = DEFAULT_FIRST_COLOR) -> None: ...
