...
class App:
    ...
    def __init__(self, root):
        ...
        frame_graphic = Frame(root)
        frame_graphic.pack()

        colors = ('red', 'orange', 'yellow', 'green', 'blue', 'indigo', 'violet')
        thickness_list = sample(range(5, 20), 6)

        canvas = gcore.CustomCanvas(frame_graphic, width=gcore.DEFAULT_CANVAS_W, height=gcore.DEFAULT_CANVAS_H, bg=gcore.DEFAULT_CANVAS_BG)
        ...
        btnClear = Button(frame_graphic, text='*отчистить*', command=events.event_btnClear)
